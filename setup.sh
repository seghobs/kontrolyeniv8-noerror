...
# Kullanim: bash -c "$(curl -sL https://raw.githubusercontent.com/seghobs/kontrolyeniv8-noerror/main/setup.sh)"
...
git clone https://github.com/seghobs/kontrolyeniv8-noerror.git mysite
